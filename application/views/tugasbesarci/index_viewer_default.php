                        ...
                        <table class="table table-hover" width="100%"> 
                                ...
                                <?php foreach ($tugasbesarci_builder_object as $key) {?> 
                                      <tr>
                                            ...
                                            <a href="<?=site_url()?>/tugasbesarci/Tampil_berita/<?php echo $key['id'] ?>">
                                          <p class="left">   <?php echo $key['Judul'] ?>
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                           ...
                           <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="<?=base_url()?>image/slider_image.jpg" alt=""  height="8px">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="<?=base_url()?>image/slider_image.jpg" alt=""  alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="<?=base_url()?>image/slider_image.jpg" alt="">
                                </div>
                            </div>
...
<!-- aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa-->
                        <table class="table table-hover" width="100%"> 
                                ...
                                <?php foreach ($tugasbesarci_builder_object1 as $key) {?> 
                                      <tr>
                                            <td rowspan="2"><a href="<?=site_url()?>/tugasbesarci/Tampil_berita/<?php echo $key['id'] ?>"><img width="90px" height="70px" src=<?=base_url("assets/uploads")."/".$key['foto'] ?>>
                                            </td>
                                            <td><type="hidden" <?php echo $key['id'] ?>>
                                            <center>
